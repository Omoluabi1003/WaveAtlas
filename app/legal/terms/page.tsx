...
{heading:"Intellectual property",body:"WaveAtlas™, WaveAtlas Daily™, Explore Humanity Through Sound™, product design, branding, and original software are owned by ETL GIS Consulting LLC or its licensors. Third-party streams, station names, logos, maps, and news content remain with their respective owners."},
...
{heading:"Limitation of liability",body:"To the maximum extent permitted by law, WaveAtlas and ETL GIS Consulting LLC are not liable for indirect, incidental, special, consequential, or exemplary damages arising from use of the service."},
{heading:"Changes and contact",body:"We may change, suspend, or discontinue features and may update these terms. Contact: legal@example.com."}
]} />; }
